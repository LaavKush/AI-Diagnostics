...
const DiscussSection = () => {
  return (
    <section className="bg-[#fdfaf7] py-24 px-6 md:px-16 flex justify-center items-center">
      <div className="max-w-screen-xl w-full grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        {/* LEFT TEXT SIDE */}
        <div>
          <h2 className="text-4xl md:text-5xl font-bold text-[#0d1b2a] mb-10 leading-tight">
        ...
        {/* RIGHT CHAT BUBBLE SIDE */}

        <div className="relative bg-gradient-to-br from-[#fffad6] to-[#fef6f4] p-10 rounded-[50px] shadow-2xl flex justify-center items-center">
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      className={`px-5 py-3 max-w-[85%] rounded-2xl text-base md:text-lg shadow-md break-words ${
                        isUser
                          ? "bg-yellow-100 text-yellow-900 self-end"
